...
function SendMessage({onSendMessage}) {
    ...
    return (
        <div className='h-full w-full flex items-end '>
            <div className=" fixed h-16 flex bottom-0 justify-center items-center bg-[#092b3d] w-4/5">
                <form className="w-full flex justify-center items-center" onSubmit={handleSubmit}>
                    <div className="input-wrapper w-2/3 relative">
                        <input className="w-full py-2 pl-5 pr-12 bg-[#0b3b55] rounded-md focus:outline-none text-white" value={input} onChange={handleChange}/ >
                        <svg
                            stroke="currentColor"
                            fill="currentColor"
                            strokeWidth="0"
